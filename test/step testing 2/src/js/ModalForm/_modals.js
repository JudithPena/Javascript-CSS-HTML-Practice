...
class Modals {
    ...
    createFirstModal() {
        ...
        <div id="enroll-block" class="popup-container">
            ...
            <form id="appointment-fixed-block" class="appointment-form block__form" action="/appointment-send"
                method="post">
                ...
                <div class="popup-doctors-choice">
                    <select class="select-css select-doctors" name="select-doctors">
                        ...
                        <option class="active-result" data-doctor="0">Кардиолог</option>
                        <option class="active-result" data-doctor="1">Стоматолог</option>
                        <option class="active-result" data-doctor="2">Терапевт</option>
                    </select>
                </div>
                ...
                <div class="inputs-all">
                    ...
                    <div class="input-wrap">
                        <input class="input-form input-purpose-visit" type="text" name="purpose-visit" value=""
                    ...
                    <div class="input-wrap">
                        <input class="input-form input-description-visit" type="text" name="description-visit" value=""
                    ...
                    <div class="popup-urgency-visit">
                        <select class="select-css select-visit" required name="select-visit">
                            ...
                            <option class="active-result" data-option-array-index="0" value="обычная">обычная</option>
                            <option class="active-result" data-option-array-index="1" value="приоритетная">приоритетная</option>
                            <option class="active-result" data-option-array-index="2" value="неотложная">неотложная</option>
                        </select>
                    </div>

                    <div class="input-wrap">
                        <input class="input-form input-name" type="text" name="name" value="" placeholder="ФИО"  required minlength="6" maxlength="100">
                ...
                <div class="inputs-cardiologist">
                    ...
                    <div class="input-wrap">
                        <input class="input-form input-pressure" type="text" name="pressure" value=""
                            placeholder="Ваше обычное давление" minlength="5" maxlength="10">
                        <label class ="validation-pressure" for="input-pressure"></label>
                    </div>
                   
                    <div class="input-wrap">
                        <input class="input-form input-body-mass-index" type="text" name="body-mass-index" value=""
                    ...
                    <div class="input-wrap">
                        <input class="input-form input-heart-disease" type="text" name="heart-disease" value=""
                ...
                <div class="inputs-therapist"> 
                    <div class="input-wrap">
                        <input class="input-form input-age" type="text" name="age" value="" placeholder="Возраст" minlength="1" maxlength="3">
                ...
                <div class="inputs-dentist">
                    <div class="input-wrap">
                        <input class="input-form input-date-last-visit" type="text" name="date-last-visit" value=""
                ...
                <div class="submit-wrap">
                    <input class="appointment-submit" type="submit" name="appointment-send" value="Создать">
                </div>
            </form>
        </div>
        `;
        ...
        this.body.addEventListener('click', (e) => {
            ...
            if (!popupContainer.contains(e.target) || e.target.className === "close-popup-js") {
                this.removeModal()
            }
        });
    ...
    selectDoctors() {
        ...
        selectDoctors.addEventListener("change", (e) => {
            ...
            const inputsAll = document.querySelector('.inputs-all');
            const inputsTherapist = document.querySelector('.inputs-therapist');
            const inputsDentist = document.querySelector('.inputs-dentist');
            const inputsCardiologist = document.querySelector('.inputs-cardiologist');
            ...
            switch (e.target.options.selectedIndex) {
                ...
                case 1:
                    ...
                    inputsAll.style.display = 'block';
                    inputsCardiologist.style.display = 'block';
                    inputsDentist.style.display = 'none';
                    inputsTherapist.style.display = 'block';

                    document.querySelector(".input-pressure").required = true;
                    document.querySelector(".input-body-mass-index").required = true;
                    document.querySelector(".input-heart-disease").required = true;
                    document.querySelector(".input-date-last-visit").required = false;
                    document.querySelector(".input-age").required = true;
                    break;

                case 2:
                    submitWrap.style.display = 'block';
                    inputsAll.style.display = 'block';
                    inputsDentist.style.display = 'block';
                    inputsCardiologist.style.display = 'none';
                    inputsTherapist.style.display = 'none';

                    document.querySelector(".input-pressure").required = false;
                    document.querySelector(".input-body-mass-index").required = false;
                    document.querySelector(".input-heart-disease").required = false;
                    document.querySelector(".input-date-last-visit").required = true;
                    document.querySelector(".input-age").required = false;
                    break;
    ...
    createVisit() {
        ...
        const formVisit = document.getElementById("appointment-fixed-block");
        formVisit.addEventListener('submit', (e) => {
            e.preventDefault();
            // console.log(formVisit.elements);
            const createCard = {
                selectDoctors: formVisit.elements["select-doctors"].options[formVisit.elements["select-doctors"].selectedIndex].text,
                purposeVisit: formVisit.elements["purpose-visit"].value,
                descriptionVisit: formVisit.elements["description-visit"].value,
                selectVisit: formVisit.elements["select-visit"].options[formVisit.elements["select-visit"].selectedIndex].text,
                name: formVisit.elements["name"].value,

                pressure: formVisit.elements["pressure"].value,
                bodyMassIndex: formVisit.elements["body-mass-index"].value,
                heartDisease: formVisit.elements["heart-disease"].value,

                age: formVisit.elements["age"].value,

                dateLastVisit: formVisit.elements["date-last-visit"].value,
            };

            api.addCard(createCard, this.wrapperModal);
