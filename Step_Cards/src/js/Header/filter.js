...
class Filter extends Element {
  ...
  render() {
    ...
    const titleSearch = this.createElement("input", ["form-control", "form-control-filter"]);
    titleSearch.setAttribute(
      "placeholder",
      "Поиск по заголовку. (пример: ФИО, Кардиолог, Терапевт, Стоматолог)"
    );
